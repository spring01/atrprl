...
gv48 = np.exp(- space_shifted * space_shifted / (2 * 24))
gv48 /= np.sum(gv48)
...
kwargs_v2['thres_loose'] = 8e-3
kwargs_v2['thres_tight'] = 3e-3
register(
    id='ATRP-ps-td-gv48-test1-v2',
    entry_point=entry_point,
    max_episode_steps=max_episode_steps,
    kwargs=kwargs_v2
)
...
kwargs_v3['thres_loose'] = 6e-3
kwargs_v3['thres_tight'] = 3e-3
register(
    id='ATRP-ps-td-gv48-test1-v3',
    entry_point=entry_point,
    max_episode_steps=max_episode_steps,
    kwargs=kwargs_v3
)
